...
export const PLAYER_CMD_PRIORITY = 'player/CMD_PRIORITY'
export const PLAYER_CMD_REPLAY = 'player/CMD_REPLAY'
export const PLAYER_CMD_SEEK = 'player/CMD_SEEK'
export const PLAYER_CMD_VOLUME = 'player/CMD_VOLUME'
export const PLAYER_CMD_TAKEOVER = 'player/CMD_TAKEOVER'
...
export const PLAYER_REQ_PRIORITY = 'server/PLAYER_REQ_PRIORITY'
...
export const MEDIA_ANALYZE_AUDIO_TRACKS = 'media/ANALYZE_AUDIO_TRACKS'
export const VOCAL_SEPARATION_STATUS = 'vocalSeparation/STATUS'
export const VOCAL_SEPARATION_MODELS_MOUNT = 'server/vocalSeparation/MODELS_MOUNT'
export const VOCAL_SEPARATION_MODELS_UNMOUNT = 'server/vocalSeparation/MODELS_UNMOUNT'
export const VOCAL_SEPARATION_PAUSE = 'server/vocalSeparation/PAUSE'
export const VOCAL_SEPARATION_RESUME = 'server/vocalSeparation/RESUME'
