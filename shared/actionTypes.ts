...
export const LIBRARY_SORT_TOGGLE = 'library/TOGGLE_SORT'
...
export const VOCAL_SEPARATION_STOP = 'server/vocalSeparation/STOP'
export const VOCAL_SEPARATION_RESUME = 'server/vocalSeparation/RESUME'
export const VOCAL_SEPARATION_RETRY = 'server/vocalSeparation/RETRY'
