...
export const VOCAL_SEPARATION_MODELS_MOUNT = 'vocalSeparation/MODELS_MOUNT'
export const VOCAL_SEPARATION_MODELS_UNMOUNT = 'vocalSeparation/MODELS_UNMOUNT'
export const VOCAL_SEPARATION_PAUSE = 'vocalSeparation/PAUSE'
export const VOCAL_SEPARATION_RESUME = 'vocalSeparation/RESUME'
