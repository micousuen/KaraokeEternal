...
description: Host awesome karaoke parties where everyone can easily find and queue songs from their phone's browser. The player is fully browser-based with support for MP4 and MKV videos plus WebGL visualizations. The server is self-hosted and runs on nearly everything.
---

Host awesome karaoke parties where everyone can easily find and queue songs from their phone's browser. The player is fully browser-based with support for MP4 and MKV videos plus WebGL visualizations. The server is self-hosted and runs on nearly everything.
